    ...
    <div class="container">
        ...
        <form action="{{ route('secciones.update', $seccion->id_seccion) }}" method="POST">
            ...
            <div class="form-group">
                ...
                <input type="text" name="nombre_seccion" class="form-control" value="{{ old('nombre_seccion', $seccion->nombre_seccion) }}"
            ...
            <div class="form-group">
                ...
                <input type="number" name="aforo" class="form-control" value="{{ old('aforo', $seccion->aforo) }}"
                       min="1" required>
